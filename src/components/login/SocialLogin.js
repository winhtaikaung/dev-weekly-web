        ...
        <div
            ...
            <div className="login-box-social-section-inner">
                ...
                <div className="row align-center">
                    <button onClick={()=>props.onFacebookLogin()} className="small-12 medium-6 login-box-social-button-facebook">Log in with facebook</button>
                </div>
                <div className="row align-center">
                    <button onClick={()=>props.onGoogleLogin()} className="small-12 medium-6 login-box-social-button-google">Log in with Google+</button>
                </div>
                <div className="row align-center">
